 ...
 <nav class="navbar navbar-default" style="background-color: #4E4C4A ">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../pages/welcomesa.php" style="color: white">Accueil</a>
    </div>
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white; background-color:rgba(138, 189, 101, 0);">Gestion des comptes <span class="caret" ></span></a>
          <ul class="dropdown-menu">  
        <li><a href="../pages/creergestionnaires.php"  style="color: black">Créer gestionnaires</a></li>
        <li><a href="../pages/creeradmin.php"  style="color: black">Créer administrateurs</a></li>
        <li><a href="../pages/listeuser.php"  style="color: black">Liste des comptes</a></li>
          </ul>
        </li>
